function Punto4() {
     const prompt = require('prompt-sync')();
        ...
        let IntNumber= parseInt(prompt("Ingrese el numero a verificar si es palindromo: "));
        ...
        if ( NewNumber === IntNumber ) {
            console.log("El numero " + IntNumber + " es un palindromo.");
        } else {
            console.log("El numero " + IntNumber + " no es un palindromo.");
        }
}

module.exports = Punto4;